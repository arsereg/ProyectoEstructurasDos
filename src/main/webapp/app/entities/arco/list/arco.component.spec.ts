...
describe('Arco Management Component', () => {
  let comp: ArcoComponent;
  let fixture: ComponentFixture<ArcoComponent>;
  let service: ArcoService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'arco', component: ArcoComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ArcoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.arcos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

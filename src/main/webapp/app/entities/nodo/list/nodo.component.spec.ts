...
describe('Nodo Management Component', () => {
  let comp: NodoComponent;
  let fixture: ComponentFixture<NodoComponent>;
  let service: NodoService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'nodo', component: NodoComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(NodoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.nodos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
